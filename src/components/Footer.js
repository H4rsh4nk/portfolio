  ...
  return (
    <div className="mt-4 bg-dark-200 rounded-md text-white px-8 py-4">
      <ul className="text-center">
        ...
        <li><a href="#honors" className="hover:underline">Projects & Experience</a></li>
      ...
      <p className="text-sm font-light text-center">Copyright © 2023 Harshank Pathak. All Right Reserved</p>
